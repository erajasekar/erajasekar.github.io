# Learnings from Uberconf - 2016 
 ...
 The only complaint, I can tell is that we are given only audio recordings of the session to listen after the conference. It would be have been great if video recordings are available after the conference.             
