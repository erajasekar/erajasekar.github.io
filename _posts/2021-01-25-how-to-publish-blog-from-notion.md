...
Like how I customized SEO tags, I added google analytics script to `index.html` , `post.html` and `tag.html` files in `themes/kartranai/layout` dir. The below screenshot shows the added script code with highlighted background.
